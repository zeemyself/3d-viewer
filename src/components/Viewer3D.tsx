  ...
  return (
    <div className="relative h-full w-full min-h-0">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div
          className="pointer-events-none absolute right-4 top-4 rounded-2xl border px-3 py-2 text-xs font-medium md:right-5 md:top-5"
          style={{ borderColor: "rgba(201, 175, 136, 0.8)", background: "rgba(255, 251, 243, 0.88)", color: "var(--text-secondary)" }}
        >
        ...
        <div
          ...
          style={{ borderColor: "rgba(201, 175, 136, 0.8)", background: "rgba(255, 251, 243, 0.88)" }}
        >
          <div className="axis-pill">
            <span className="h-2 w-2 rounded-full" style={{ background: "#dd5b34" }} />X
          </div>
          <div className="axis-pill">
            <span className="h-2 w-2 rounded-full" style={{ background: "#45a875" }} />Y
          </div>
          <div className="axis-pill">
            <span className="h-2 w-2 rounded-full" style={{ background: "#3d65ba" }} />Z
          </div>
        </div>
      </div>
    </div>
