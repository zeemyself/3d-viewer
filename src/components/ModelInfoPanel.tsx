...
import { calculateModelInfo, formatNumber, formatVolume } from "../lib/model-utils";
...
export function ModelInfoPanel({ model, selectedIndex }: ModelInfoPanelProps) {
  ...
  return (
    <div className="panel-inner">
      <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--text-tertiary)" }}>
        Geometry Data
      </h3>
          ...
          {[
            ...
            <div key={label} className="metric-card p-3">
              <div className="mb-1 flex items-center gap-1.5">
                <span className="h-1.5 w-1.5 rounded-full" style={{ background: "var(--accent-cyan)" }} />
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="metric-card p-3.5">
            <div className="flex items-center gap-2">
              <svg className="h-4 w-4" style={{ color: "var(--accent-success)" }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-1.5 text-base font-semibold" style={{ color: "var(--text-primary)", fontFamily: "var(--font-mono)" }}>
          ...
          <div className="metric-card p-3.5">
            <div className="flex items-center gap-2">
              <svg className="h-4 w-4" style={{ color: "var(--accent-warning)" }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="panel-surface p-3.5">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="mt-1 text-lg font-semibold" style={{ color: "var(--text-primary)", fontFamily: "var(--font-mono)" }}>
