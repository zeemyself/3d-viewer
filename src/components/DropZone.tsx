        ...
        {isLoading ? (
          <div className="flex flex-col items-center py-6 animate-fade-in">
            <div className="relative mb-6 h-16 w-16">
              ...
              />
              <div className="absolute inset-2.5 rounded-full" style={{ background: "var(--bg-tertiary)" }} />
            </div>
          ...
          <div className="animate-slide-up">
            ...
            <p className="mx-auto mt-2 max-w-md text-center text-sm" style={{ color: "var(--text-secondary)" }}>
              Drag and drop a file here or open the picker to inspect dimensions and mesh structure.
            </p>
            ...
            <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
              {[
                ...
                <div key={ext} className="rounded-full border px-3 py-1 text-xs" style={{ borderColor: "var(--border-dim)" }}>
                  <span className="mr-1.5 inline-block h-1.5 w-1.5 rounded-full" style={{ background: color }} />
                  <span style={{ color: "var(--text-tertiary)", fontFamily: "var(--font-mono)" }}>{ext}</span>
                </div>
              ))}
            </div>
          </div>
